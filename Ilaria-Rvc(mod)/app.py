...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="blue", secondary_hue="emerald"), title="RVC") as app:
    with gr.Tabs():
        ...
        with gr.TabItem("Download Voice Models"):
            ...
            with gr.Row():
                gr.Markdown(
                """
                Made with ❤ by Ilaria and Blane | Support  [Ilaria Ko-Fi](https://ko-fi.com/ilariaowo) [Blane Ko-Fi](https://ko-fi.com/blane187)
                """
                )
